...
include('../config.php');
    ...
    isset ($_POST['email']) && !empty($_POST['email'])) {
        ...
        mysql_query("INSERT INTO usuarios (full_name,username,password,email)
        VALUES ('{$full_name}','{$username}','{$password}','{$mail}')",$link);
        ...
        if(!empty($my_error)) {
            ...
            header ("Location: ../registrar.php?errordat");

        } else {

             header ("Location: ../registrar.php?sucess");

        }

    } else {

         header ("Location: ../registrar.php?errordb");
