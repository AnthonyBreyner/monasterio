...
<h1 align="center">Cesta de Comida</h1> 
<?php 
if($carro){ 
?> 
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center"> 
 ...
 $contador++; 
 ?> 
 <form name="a<?php echo $v['identificador'] ?>" method="post" action="vercarrito.php?<?php echo SID ?>" id="a<?php echo $v['identificador'] ?>"> 
...
<div align="center"><span class="prod">Total de Art�culos: <?php echo count($carro); ?></span> 
</div><br> 
...
<div align="center"><span class="prod">Continuar la selecci�n de productos</span> 
 ...
 <a href="regpago.php?">Procesar Pedido</a> 
</div> 
